...
>(socket: IoPromiseSocket, opts?: { eventName: string }): <Request extends RequestResponse['request']>(request: Request) => Promise<GetResponseRecord<RequestResponse, Request>>;
declare function createIoPromise<
  RequestResponse extends RequestResponsePair,
>(socket: IoPromiseSocket, opts?: { eventName: string }): <Request extends RequestResponse[0]>(request: Request) => Promise<GetResponsePair<RequestResponse, Request>>;
